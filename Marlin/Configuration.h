...
#define STRING_CONFIG_H_AUTHOR "kdang" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "PrentaDuoGodMode"

// Define this to set a unique identifier for this printer, (Used by some programs to differentiate between machines)
// You can use an online service to generate a random UUID. (eg http://www.uuidgenerator.net/version4)
#define MACHINE_UUID "b2ff5a70-e920-4ec6-8ac3-38876a855664"
...
#define HOTEND_OFFSET_X {0.0, 34.86} // (in mm) for each extruder, offset of the hotend on the X axis
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 156.56
  #define DEFAULT_bedKi 15.41
  #define DEFAULT_bedKd 397.59
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 8, 64 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_ACCELERATION      { 512, 512, 128, 4096 }
 ...
 */
#define DEFAULT_ACCELERATION          512    // X, Y, Z and E acceleration for printing moves
#define DEFAULT_RETRACT_ACCELERATION  4096    // E acceleration for retracts
#define DEFAULT_TRAVEL_ACCELERATION   512    // X, Y, Z acceleration for travel (non printing) moves
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER 72  // X offset: -left  +right  [of the nozzle]
 ...
 */
  ...
  #define PROBE_PT_1_X -28
  #define PROBE_PT_1_Y 0
  #define PROBE_PT_2_X 28
  #define PROBE_PT_2_Y 200
  #define PROBE_PT_3_X 200-72
...
// Homing speeds (mm/m)
#define HOMING_FEEDRATE_XY (2048)
